...
UCLASS()
class SOMERPG_API ASpawnVolume : public AActor
{
	GENERATED_BODY()
...
public:
	...
	// BlueprintNativeEvent - has native C++ functionality and also have blueprint functionality
