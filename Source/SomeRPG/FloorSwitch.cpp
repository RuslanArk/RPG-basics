...
AFloorSwitch::AFloorSwitch()
{
	...
	/** SetCollisionEnabled allows to specify the type of collision enabled for this actor 
	 * These functions are thr representation of collision division in the engine
	*/
